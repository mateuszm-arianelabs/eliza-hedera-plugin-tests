...
describe("claim_airdrop", () => {
    ...
    let token1: string;
    let token2: string;
    // assume that account used with eliza hedera plugin is the same as the one used in the test
    // and has MaxAutomaticTokenAssociations = 0 otherwise test will be skipped
